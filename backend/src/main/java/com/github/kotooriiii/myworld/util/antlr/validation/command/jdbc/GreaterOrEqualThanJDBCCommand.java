...
public class GreaterOrEqualThanJDBCCommand extends JDBCCommand
{
    @Getter(lazy = true)
    private static final GreaterOrEqualThanJDBCCommand instance = new GreaterOrEqualThanJDBCCommand();
